...
def train_baseline(epoch, encoder,decoder,scheduler,train_loader,optimizer,rel_rec,rel_send,valid_loader,encoder_file,decoder_file,log,best_val_loss,args):
    t = time.time()
    nll_train = []
    acc_train = []
    kl_train = []
...
def test_baseline(encoder,decoder,rel_rec,rel_send,test_loader,encoder_file,decoder_file,save_folder,log,args):
    acc_test = []
    nll_test = []
    kl_test = []
    mse_test = []
    ...
    print("Baseline Model Test Finished.")
...
#     val_loss = train_baseline(epoch, best_val_loss)
