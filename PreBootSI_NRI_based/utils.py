...
def kl_categorical(preds, prior, num_atoms, eps=1e-16):
    # print(torch.log(preds + eps),torch.log(prior))
    # kl_div = preds * (torch.log(preds + eps) - (prior))
    kl_div = preds * (torch.log(preds + eps) - torch.log(prior))
    return kl_div.sum() / (num_atoms * preds.size(0))


def kl_categorical_uniform(preds, num_atoms, num_edge_types, add_const=True,
                           eps=1e-32):
    kl_div = preds * torch.log(preds + eps)
    # print(kl_div)
    if add_const:
        const = np.log(num_edge_types)/num_edge_types
        # print(const)
        kl_div += const
    return kl_div.sum() / (num_atoms * preds.size(0))
...
def load_netsims_data_pse(args):
    ...
    # bold_train = np.load( args.pseudo_label_save_folder + '/bold_train_' +'netsims15r1.npy')
    edges_train = np.load(args.pseudo_label_save_folder + '/edges_trainnetsimspse.npy' )
    edges_train[edges_train > 0] = 1

    # bold_valid = np.load(args.pseudo_label_save_folder + '/bold_valid_' +'netsims15r1.npy')
    edges_valid = np.load(args.pseudo_label_save_folder + '/edges_validnetsimspse.npy')
    edges_valid[edges_valid > 0] = 1

    # bold_test = np.load(args.pseudo_label_save_folder + '/bold_test_' +'netsims15r1.npy')
    edges_test = np.load(args.pseudo_label_save_folder + '/edges_testnetsimspse.npy')
    edges_test[edges_test > 0] = 1
...
def load_netsims_data(args):



    bold_train = np.load( args.pse_data_path + 'bold_train_' +'netsims15r1.npy')
    edges_train = np.load(args.pse_data_path + 'edges_train_netsims15r1.npy' )
    edges_train[edges_train > 0] = 1

    bold_valid = np.load(args.pse_data_path + 'bold_valid_' +'netsims15r1.npy')
    edges_valid = np.load(args.pse_data_path + 'edges_valid_netsims15r1.npy')
    edges_valid[edges_valid > 0] = 1

    bold_test = np.load(args.pse_data_path + 'bold_test_' +'netsims15r1.npy')
    edges_test = np.load(args.pse_data_path + 'edges_test_netsims15r1.npy')
    edges_test[edges_test > 0] = 1
...
def load_springs_data_pse(args):
    ...
    # loc_train = np.load(args.pseudo_label_save_folder + '/loc_train_' +'springs15r1.npy')
    # vel_train = np.load(args.pseudo_label_save_folder + '/vel_train_' +'springs15r1.npy')
    edges_train = np.load(args.pseudo_label_save_folder + '/edges_trainspringspse.npy')
    edges_train[edges_train > 0] = 1

    # loc_valid = np.load(args.pseudo_label_save_folder + '/loc_valid_' +'springs15r1.npy')
    # vel_valid = np.load(args.pseudo_label_save_folder + '/vel_valid_' +'springs15r1.npy')
    edges_valid = np.load(args.pseudo_label_save_folder + '/edges_validspringspse.npy')
    edges_valid[edges_valid > 0] = 1

    # loc_test = np.load(args.pseudo_label_save_folder + '/loc_test_' +'springs15r1.npy')
    # vel_test = np.load(args.pseudo_label_save_folder + '/vel_test_' +'springs15r1.npy')
    edges_test = np.load(args.pseudo_label_save_folder + '/edges_testspringspse.npy')
    edges_test[edges_test > 0] = 1
...
def load_springs_data(args):



    loc_train = np.load(args.pse_data_path + 'loc_train_' +'springs15r1.npy')
    vel_train = np.load(args.pse_data_path + 'vel_train_' +'springs15r1.npy')
    edges_train = np.load(args.pse_data_path + 'edges_train_springs15r1.npy')
    edges_train[edges_train > 0] = 1

    loc_valid = np.load(args.pse_data_path + 'loc_valid_' +'springs15r1.npy')
    vel_valid = np.load(args.pse_data_path + 'vel_valid_' +'springs15r1.npy')
    edges_valid = np.load(args.pse_data_path + 'edges_valid_springs15r1.npy')
    edges_valid[edges_valid > 0] = 1

    loc_test = np.load(args.pse_data_path + 'loc_test_' +'springs15r1.npy')
    vel_test = np.load(args.pse_data_path + 'vel_test_' +'springs15r1.npy')
    edges_test = np.load(args.pse_data_path + 'edges_test_springs15r1.npy')
    edges_test[edges_test > 0] = 1
...
def load_emt_data(args):

    keep_str = '.npy'
    root_str = 'emt_data/'

    bold_train = np.load(root_str + 'traj_train' + keep_str)
    edges_train = np.load(root_str + 'edges_train' + keep_str)
    edges_train[edges_train > 0] = 1

    bold_valid = np.load(root_str + 'traj_val' + keep_str)
    edges_valid = np.load(root_str + 'edges_val' + keep_str)
    edges_valid[edges_valid > 0] = 1

    bold_test = np.load(root_str + 'traj_test' + keep_str)
    edges_test = np.load(root_str + 'edges_test' + keep_str)
    edges_test[edges_test > 0] = 1
